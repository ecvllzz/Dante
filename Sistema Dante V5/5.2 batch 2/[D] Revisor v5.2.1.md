...
- I. RELATÓRIO
- II. VOTO (com numeração hierárquica: 1., 1.1, 1.2, 2., 2.1, etc)
- III. DISPOSITIVO

**Verificação:**

- Estrutura tripartida presente?
- Numeração hierárquica correta (não "flat": 1., 2., 3. em vez de 1., 1.1, 1.2)?
...
Dispositivo DEVE ser copiado EXATAMENTE do Handoff, sem alterações. Permitido apenas ajustes de formatação (maiúsculas, pontuação).

**Verificação:**

- Dispositivo do voto == dispositivo do Handoff?
- Não há adições ("Ante o exposto...", "mantendo sentença por seus fundamentos")?
- Não há alterações de verbo ou estrutura?
...
[Texto com alterações em **negrito**]
...
[Dispositivo canônico, sem alterações se já estava correto]
